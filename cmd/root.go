...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.bsa-reader.yaml)")
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.bsa-reader.yaml)")
...
// 		// Search config in home directory with name ".bsa-reader" (without extension).
// 		viper.AddConfigPath(home)
// 		viper.SetConfigName(".bsa-reader")
// 	}
